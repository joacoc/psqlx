...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of _psqlSettings"][::std::mem::size_of::<_psqlSettings>() - 480usize];
    ...
    ["Offset of field: _psqlSettings::crosstab_flag"]
        [::std::mem::offset_of!(_psqlSettings, crosstab_flag) - 272usize];
    ["Offset of field: _psqlSettings::ctv_args"]
        [::std::mem::offset_of!(_psqlSettings, ctv_args) - 280usize];
    ["Offset of field: _psqlSettings::notty"]
        [::std::mem::offset_of!(_psqlSettings, notty) - 312usize];
    ["Offset of field: _psqlSettings::getPassword"]
        [::std::mem::offset_of!(_psqlSettings, getPassword) - 316usize];
    ["Offset of field: _psqlSettings::cur_cmd_source"]
        [::std::mem::offset_of!(_psqlSettings, cur_cmd_source) - 320usize];
    ["Offset of field: _psqlSettings::cur_cmd_interactive"]
        [::std::mem::offset_of!(_psqlSettings, cur_cmd_interactive) - 328usize];
    ["Offset of field: _psqlSettings::sversion"]
        [::std::mem::offset_of!(_psqlSettings, sversion) - 332usize];
    ["Offset of field: _psqlSettings::progname"]
        [::std::mem::offset_of!(_psqlSettings, progname) - 336usize];
    ["Offset of field: _psqlSettings::inputfile"]
        [::std::mem::offset_of!(_psqlSettings, inputfile) - 344usize];
    ["Offset of field: _psqlSettings::lineno"]
        [::std::mem::offset_of!(_psqlSettings, lineno) - 352usize];
    ["Offset of field: _psqlSettings::stmt_lineno"]
        [::std::mem::offset_of!(_psqlSettings, stmt_lineno) - 360usize];
    ["Offset of field: _psqlSettings::timing"]
        [::std::mem::offset_of!(_psqlSettings, timing) - 368usize];
    ["Offset of field: _psqlSettings::logfile"]
        [::std::mem::offset_of!(_psqlSettings, logfile) - 376usize];
    ["Offset of field: _psqlSettings::vars"]
        [::std::mem::offset_of!(_psqlSettings, vars) - 384usize];
    ["Offset of field: _psqlSettings::dead_conn"]
        [::std::mem::offset_of!(_psqlSettings, dead_conn) - 392usize];
    ["Offset of field: _psqlSettings::autocommit"]
        [::std::mem::offset_of!(_psqlSettings, autocommit) - 400usize];
    ["Offset of field: _psqlSettings::on_error_stop"]
        [::std::mem::offset_of!(_psqlSettings, on_error_stop) - 401usize];
    ["Offset of field: _psqlSettings::quiet"]
        [::std::mem::offset_of!(_psqlSettings, quiet) - 402usize];
    ["Offset of field: _psqlSettings::singleline"]
        [::std::mem::offset_of!(_psqlSettings, singleline) - 403usize];
    ["Offset of field: _psqlSettings::singlestep"]
        [::std::mem::offset_of!(_psqlSettings, singlestep) - 404usize];
    ["Offset of field: _psqlSettings::hide_compression"]
        [::std::mem::offset_of!(_psqlSettings, hide_compression) - 405usize];
    ["Offset of field: _psqlSettings::hide_tableam"]
        [::std::mem::offset_of!(_psqlSettings, hide_tableam) - 406usize];
    ["Offset of field: _psqlSettings::fetch_count"]
        [::std::mem::offset_of!(_psqlSettings, fetch_count) - 408usize];
    ["Offset of field: _psqlSettings::histsize"]
        [::std::mem::offset_of!(_psqlSettings, histsize) - 412usize];
    ["Offset of field: _psqlSettings::ignoreeof"]
        [::std::mem::offset_of!(_psqlSettings, ignoreeof) - 416usize];
    ["Offset of field: _psqlSettings::echo"]
        [::std::mem::offset_of!(_psqlSettings, echo) - 420usize];
    ["Offset of field: _psqlSettings::echo_hidden"]
        [::std::mem::offset_of!(_psqlSettings, echo_hidden) - 424usize];
    ["Offset of field: _psqlSettings::on_error_rollback"]
        [::std::mem::offset_of!(_psqlSettings, on_error_rollback) - 428usize];
    ["Offset of field: _psqlSettings::comp_case"]
        [::std::mem::offset_of!(_psqlSettings, comp_case) - 432usize];
    ["Offset of field: _psqlSettings::histcontrol"]
        [::std::mem::offset_of!(_psqlSettings, histcontrol) - 436usize];
    ["Offset of field: _psqlSettings::prompt1"]
        [::std::mem::offset_of!(_psqlSettings, prompt1) - 440usize];
    ["Offset of field: _psqlSettings::prompt2"]
        [::std::mem::offset_of!(_psqlSettings, prompt2) - 448usize];
    ["Offset of field: _psqlSettings::prompt3"]
        [::std::mem::offset_of!(_psqlSettings, prompt3) - 456usize];
    ["Offset of field: _psqlSettings::verbosity"]
        [::std::mem::offset_of!(_psqlSettings, verbosity) - 464usize];
    ["Offset of field: _psqlSettings::show_all_results"]
        [::std::mem::offset_of!(_psqlSettings, show_all_results) - 468usize];
    ["Offset of field: _psqlSettings::show_context"]
        [::std::mem::offset_of!(_psqlSettings, show_context) - 472usize];
};
